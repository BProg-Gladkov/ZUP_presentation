...
Функция Периоды_ШаблонКода()
	...
	ПараметрыШаблона.Вставить("ИспользоватьКонецПериода", Формат(Периоды_ИспользоватьКонецПериода, "БЛ=Ложь; БИ=Истина"));                
...
Процедура ОбновитьШаблоныКода()
	...
	Если КадровыеДанныеФизическихЛиц_Использовать Тогда
