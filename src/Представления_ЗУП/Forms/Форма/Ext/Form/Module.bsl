...
Процедура СрезПоследних_Инициаизировать()
	...
	СрезПоследних_ИмяРегистра = "";
	СрезПоследних_ТолькоРазрешенные = Ложь;
	
	Обновить_СрезПоследних__ТаблицаПолей();
...
&НаСервере
Процедура Обновить_СрезПоследних__ТаблицаПолей()
...
Функция СрезПоследних_ТекстЗапроса()
	...
	ПараметрыЗапроса.Вставить("ИмяРегистра", БулевоСтрокой(СрезПоследних_ИмяРегистра));
...
Процедура Инициализировать()
	...
	СрезПоследних_Использовать = Ложь;
...
Процедура ОбновитьТекстыЗапросов()
	...
	Если СрезПоследних_Использовать Тогда
		Если НЕ Периоды_Использовать ИЛИ НЕ Периоды_ДобавитьВыборкуСотрудников Тогда
		    ТекстСообщения = НСтр("ru = 'Требуется включить выборку сотрудников. См. ""Периоды""'"); 
